...
class NewRobotsSceneCfg(InteractiveSceneCfg):
    ...
    # robot
    Jetbot = JETBOT_CONFIG.replace(prim_path="{ENV_REGEX_NS}/Jetbot") # type: ignore
    Dofbot = DOFBOT_CONFIG.replace(prim_path="{ENV_REGEX_NS}/Dofbot") # type: ignore
    

# stepping the simulation while updating the scene entities appropriately.

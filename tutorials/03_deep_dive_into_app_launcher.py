...
# SimulationApp arguments https://docs.omniverse.nvidia.com/py/isaacsim/source/extensions/omni.isaac.kit/docs/index.html#isaacsim.SimulationApp
parser.add_argument(
...
def design_scene():
    ...
    # spawn distant(directional) light
    ...
    cfg_cuboid.func("/World/Object", cfg_cuboid, translation=(0.0, 0.0, args_cli.size / 2.0))
...
def main():
    ...
    sim_cfg = sim_utils.SimulationCfg(dt=0.01, device=args_cli.device) # +device=args_cli.device
